"""
tooltip.py
Authors: vegaseat, Victor Zaccardo, Alberto Vassena
A class used to display tooltips over tkinter widgets. This code is credited to the users above with only
formatting changes made by me, the full credits are below in the class block comment.
"""
